...
/**
 * Adapter for displaying friends with checkboxes for forward message feature
...
public class ForwardFriendsAdapter extends RecyclerView.Adapter<ForwardFriendsAdapter.ViewHolder> {
    ...
    public ForwardFriendsAdapter(List<User> friends, OnSelectionChangedListener listener) {
        ...
        this.filteredFriends = new ArrayList<>(allFriends);
    ...
    public void updateFriends(List<User> newFriends) {
        this.allFriends = newFriends != null ? newFriends : new ArrayList<>();
        this.filteredFriends = new ArrayList<>(allFriends);
